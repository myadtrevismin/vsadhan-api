...
namespace VidyaSadhan_API.Migrations
{
    ...
    [Migration("20200914141549_materials")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.Account", b =>
                {
                    ...
                    b.Property<string>("NaCategory")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NaSubCategory")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.Material", b =>
                {
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.MaterialFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.StudentAssignment", b =>
                {
                    b.Property<int>("AssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AssignmentId", "UserId", "CreationDate");
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.Attendance", b =>
                {
                    ...
                    b.HasOne("VidyaSadhan_API.Entities.Account", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.MaterialFile", b =>
                {
                    b.HasOne("VidyaSadhan_API.Entities.Material", "Material")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("VidyaSadhan_API.Entities.StudentAssignment", b =>
                {
                    b.HasOne("VidyaSadhan_API.Entities.Assignment", "Assignment")
