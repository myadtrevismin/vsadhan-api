...
namespace VidyaSadhan_API.Controllers
{
    ...
    public class EnrollmentController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(int), 200)]
        [ProducesErrorResponseType(typeof(VSException))]
        public async Task<IActionResult> Post([FromBody] EnrollmentViewModel Enrollment)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(int), 200)]
        [ProducesErrorResponseType(typeof(VSException))]
        public async Task<IActionResult> Put(EnrollmentViewModel Enrollment)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(int), 200)]
        [ProducesErrorResponseType(typeof(VSException))]
        public async Task<IActionResult> Delete(EnrollmentViewModel Enrollment)
        {
            try
            {
